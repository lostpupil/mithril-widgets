...
export default class simpleSearchTable {
    ...
    view(vnode) {
        return m('div.table-responsive', [
            ...
            m("table.table.is-fullwidth.is-striped", [
                m("thead",
                    m("tr", this.headers.map(({
                        key,
                        text
                    }) => {
                        return m('th', text)
            ...
            m("nav.pagination.is-centered", {
                ...
                m("ul.pagination-list", this.page_items().map((itm) => {
                    return m("li",
                        m(`a.pagination-link[aria-label="go to ${itm}"]`, {
